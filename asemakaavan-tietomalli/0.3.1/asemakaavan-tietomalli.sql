...
-- 
-- object: "qaava-asemakaava" | type: DATABASE --
-- DROP DATABASE IF EXISTS "qaava-asemakaava";
CREATE DATABASE "qaava-asemakaava";
-- ddl-end --
...
-- ddl-end --
INSERT INTO koodistot.osa_alue_tyyppi (gid, nimi, gid_hsrcl, koodi) VALUES (E'69', E'Kaupungin- tai kunnanosan raja', DEFAULT, DEFAULT);
-- ddl-end --
INSERT INTO koodistot.osa_alue_tyyppi (gid, nimi, gid_hsrcl, koodi) VALUES (E'70', E'Korttelin, korttelinosan ja alueen raja', DEFAULT, DEFAULT);
-- ddl-end --
INSERT INTO koodistot.osa_alue_tyyppi (gid, nimi, gid_hsrcl, koodi) VALUES (E'75', E'Ohjeellinen alueen tai osa-alueen raja', DEFAULT, DEFAULT);
-- ddl-end --
INSERT INTO koodistot.osa_alue_tyyppi (gid, nimi, gid_hsrcl, koodi) VALUES (E'76', E'Ohjeellinen tontin/rakennuspaikan raja', DEFAULT, DEFAULT);
-- ddl-end --
INSERT INTO koodistot.osa_alue_tyyppi (gid, nimi, gid_hsrcl, koodi) VALUES (E'77', E'Osa-alueen raja', DEFAULT, DEFAULT);
-- ddl-end --
INSERT INTO koodistot.osa_alue_tyyppi (gid, nimi, gid_hsrcl, koodi) VALUES (E'81', E'Sitovan tonttijaon mukaisen tontin raja', DEFAULT, DEFAULT);
-- ddl-end --
...
INSERT INTO koodistot.numeerinen_merkintatyyppi (gid, tyyppi) VALUES (E'1', E'Luku osoittaa ehdottomasti käytettävän rakennusoikeuden, rakennuksen korkeuden, kattokaltevuuden tai muun määräyksen');
-- ddl-end --
INSERT INTO koodistot.numeerinen_merkintatyyppi (gid, tyyppi) VALUES (E'2', E'Alueeseen tai kohteeseen liittyvä kirjain- tai numerotunnus');
-- ddl-end --
INSERT INTO koodistot.numeerinen_merkintatyyppi (gid, tyyppi) VALUES (E'3', E'Kadun, tien, katuaukion, torin, puiston tai muun yleisen alueen nimi');
-- ddl-end --
INSERT INTO koodistot.numeerinen_merkintatyyppi (gid, tyyppi) VALUES (E'4', E'Kattokaltevuus');
-- ddl-end --
INSERT INTO koodistot.numeerinen_merkintatyyppi (gid, tyyppi) VALUES (E'5', E'Kaupungin- tai kunnanosan nimi');
-- ddl-end --
INSERT INTO koodistot.numeerinen_merkintatyyppi (gid, tyyppi) VALUES (E'6', E'Kaupungin- tai kunnanosan numero');
-- ddl-end --
INSERT INTO koodistot.numeerinen_merkintatyyppi (gid, tyyppi) VALUES (E'7', E'Korttelin numero');
-- ddl-end --
INSERT INTO koodistot.numeerinen_merkintatyyppi (gid, tyyppi) VALUES (E'8', E'Luku osoittaa neliömetreinä, kuinka suuren osan rakennuksen alimmasta kerroksesta (I) saa kerrosalaneliömetreinä ilmoitetun kerrosalan lisäksi käyttää asukkaiden yhteistiloihin');
-- ddl-end --
INSERT INTO koodistot.numeerinen_merkintatyyppi (gid, tyyppi) VALUES (E'9', E'Luku osoittaa, kuinka suuren osan alueesta tai rakennusalasta saa käyttää rakentamiseen');
-- ddl-end --
INSERT INTO koodistot.numeerinen_merkintatyyppi (gid, tyyppi) VALUES (E'10', E'Luku osoittaa, kuinka suuri osa rakennuksen alimmasta kerroksesta (I) tulee käyttää päiväkodin tiloiksi');
-- ddl-end --
INSERT INTO koodistot.numeerinen_merkintatyyppi (gid, tyyppi) VALUES (E'11', E'Maanpinnan likimääräinen korkeusasema');
-- ddl-end --
INSERT INTO koodistot.numeerinen_merkintatyyppi (gid, tyyppi) VALUES (E'12', E'Kuinka monta autopaikkaa asuntoa kohti on rakennettava');
-- ddl-end --
INSERT INTO koodistot.numeerinen_merkintatyyppi (gid, tyyppi) VALUES (E'13', E'Kuinka monta kerrosalaneliömetriä kohti on rakennettava yksi autopaikka');
-- ddl-end --
INSERT INTO koodistot.numeerinen_merkintatyyppi (gid, tyyppi) VALUES (E'14', E'Kuinka monta prosenttia rakennusalalle sallitusta kerrosalasta saadaan käyttää asuinhuoneistoja varten');
-- ddl-end --
INSERT INTO koodistot.numeerinen_merkintatyyppi (gid, tyyppi) VALUES (E'15', E'Kuinka monta prosenttia rakennusalalle sallitusta kerrosalasta saadaan käyttää myymälätiloja varten');
-- ddl-end --
INSERT INTO koodistot.numeerinen_merkintatyyppi (gid, tyyppi) VALUES (E'16', E'Kuinka suuren osan rakennuksen suurimman kerroksen alasta saa kellarikerroksessa käyttää kerrosalaan luettavaksi tilaksi');
-- ddl-end --
INSERT INTO koodistot.numeerinen_merkintatyyppi (gid, tyyppi) VALUES (E'17', E'Kuinka suuren osan rakennuksen suurimman kerroksen alasta ullakon tasolla saa käyttää kerrosalaan laskettavaksi tilaksi');
-- ddl-end --
INSERT INTO koodistot.numeerinen_merkintatyyppi (gid, tyyppi) VALUES (E'18', E'Ohjeellisen tontin/rakennuspaikan numero');
-- ddl-end --
INSERT INTO koodistot.numeerinen_merkintatyyppi (gid, tyyppi) VALUES (E'19', E'Rakennuksen julkisivun enimmäiskorkeus metreinä');
-- ddl-end --
INSERT INTO koodistot.numeerinen_merkintatyyppi (gid, tyyppi) VALUES (E'20', E'Rakennuksen julkisivupinnan ja vesikaton leikkauskohdan ylin korkeusasema');
-- ddl-end --
INSERT INTO koodistot.numeerinen_merkintatyyppi (gid, tyyppi) VALUES (E'21', E'Rakennuksen vesikaton ylimmän kohdan korkeusasema');
-- ddl-end --
INSERT INTO koodistot.numeerinen_merkintatyyppi (gid, tyyppi) VALUES (E'22', E'Rakennuksen, rakenteiden ja laitteiden ylin korkeusasema');
-- ddl-end --
INSERT INTO koodistot.numeerinen_merkintatyyppi (gid, tyyppi) VALUES (E'23', E'Rakennusoikeus kerrosalaneliömetreinä');
-- ddl-end --
INSERT INTO koodistot.numeerinen_merkintatyyppi (gid, tyyppi) VALUES (E'24', E'Rakennuksen tai sen osan suurin sallittu kerrosluku');
-- ddl-end --
INSERT INTO koodistot.numeerinen_merkintatyyppi (gid, tyyppi) VALUES (E'25', E'Korttelinumerot, joiden autopaikkoja saa alueelle sijoittaa');
-- ddl-end --
INSERT INTO koodistot.numeerinen_merkintatyyppi (gid, tyyppi) VALUES (E'27', E'Tehokkuusluku eli kerrosalan suhde tontin/rakennuspaikan pinta-alaan');
-- ddl-end --
INSERT INTO koodistot.numeerinen_merkintatyyppi (gid, tyyppi) VALUES (E'29', E'Sitovan tonttijaon mukaisen tontin numero');
-- ddl-end --
INSERT INTO koodistot.numeerinen_merkintatyyppi (gid, tyyppi) VALUES (E'31', E'Desibelimäärä');
-- ddl-end --
...
INSERT INTO koodistot.tietomalli_metatiedot (gid, nimi, versio) VALUES (E'1', E'asemakaava', E'0.3.0');
-- ddl-end --
